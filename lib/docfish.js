...
// Document collection designed to track all available docs.
var Docs = function() {};
...
var outputSite = function(docs) {
    ...
    _(docs.sort().languages()).each(function(lang) {
        tocs[lang] = templates.toc({docs: docs.filter('lang', lang), lang: lang});
    });
    ...
    _(docs).each(function(doc) {
        ...
        // Render doc
        doc.content = _.template(doc.content)({toc: tocs[doc.lang]});
